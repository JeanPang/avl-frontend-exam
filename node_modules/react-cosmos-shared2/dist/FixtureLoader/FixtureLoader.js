...
function (_React$Component) {
  ...
  function FixtureLoader() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(FixtureLoader)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(FixtureLoader, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_FixtureProvider.FixtureProvider // renderKey controls whether to reuse previous instances (and
