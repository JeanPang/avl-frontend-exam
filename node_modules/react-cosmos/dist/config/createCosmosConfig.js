...
function createCosmosConfig(rootDir) {
  ...
  return _objectSpread({}, cosmosConfigInput, {
    rootDir: rootDir,
...
function getExportPath(cosmosConfigInput, rootDir) {
  var _cosmosConfigInput$ex = cosmosConfigInput.exportPath,
      exportPath = _cosmosConfigInput$ex === void 0 ? 'cosmos-export' : _cosmosConfigInput$ex;
