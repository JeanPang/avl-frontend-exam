...
function _getUserWebpackConfig() {
  _getUserWebpackConfig = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(cosmosConfig, userWebpack) {
...
function _getBaseWebpackConfig() {
  _getBaseWebpackConfig = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee2(cosmosConfig, userWebpack) {
    var rootDir, _createWebpackCosmosC2, configPath, relPath, userConfigExport;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 5:
            ...
            _context2.next = 11;
            return userConfigExport(_yargs.argv.env || getNodeEnv(), _yargs.argv);
...
function resolveLocalReactDeps(cosmosConfig, baseWebpackConfig) {
  ...
  var _resolve$alias = resolve.alias,
      alias = _resolve$alias === void 0 ? {} : _resolve$alias;
  return _objectSpread({}, resolve, {
    alias: _objectSpread({}, alias, {
