...
function _generateExport() {
  _generateExport = _asyncToGenerator(
  /*#__PURE__*/
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            cosmosConfig = (0, _config.detectCosmosConfig)(); // Copy static assets first, so that the built index.html overrides the its
...
function exportPlaygroundFiles(cosmosConfig) {
  ...
  var playgroundHtml = (0, _playgroundHtml.getExportPlaygroundHtml)(cosmosConfig);
