...
function getDevPlaygroundHtml(platformType, cosmosConfig) {
  var ui = cosmosConfig.ui;
  return getPlaygroundHtml(_objectSpread({}, ui, {
    core: getDevCoreConfig(platformType, cosmosConfig)
  }));
}

function getExportPlaygroundHtml(cosmosConfig) {
  var ui = cosmosConfig.ui;
  return getPlaygroundHtml(_objectSpread({}, ui, {
...
function getDevCoreConfig(platformType, cosmosConfig) {
  switch (platformType) {
    case 'native':
      return _objectSpread({}, getSharedCoreConfig(cosmosConfig), {
        devServerOn: true,
        webRendererUrl: null
      });
...
function getWebRendererUrl(_ref) {
  ...
  return _url.default.resolve(publicUrl, RENDERER_FILENAME);
}

function getPlaygroundHtml(playgroundConfig) {
